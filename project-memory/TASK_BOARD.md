...
|----|-------|--------|------------|--------------|--------|
| T001 | MVP public pages | Complete | — | 2026-04-25 | 33 public routes |
| T002 | AI Pricing Tracker + History | Complete | T001 | 2026-04-25 | /insights/ai-pricing-tracker, /pricing-history |
...
| T012 | Project memory system | Complete | — | 2026-05-03 | /project-memory/ |
| T013 | Fix homepage mobile overflow | Planned | T011 | — | Layout hero fix |
