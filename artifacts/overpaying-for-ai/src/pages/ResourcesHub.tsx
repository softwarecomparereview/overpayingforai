          ...
          <div className="grid sm:grid-cols-2 gap-3">
            <Link href="/calculator">
              <div
                ...
                className="group flex items-center gap-4 border border-emerald-200 bg-white rounded-xl px-5 py-4 hover:border-emerald-400 hover:shadow-sm transition-all cursor-pointer"
              >
            ...
            <Link href="/decision-engine">
              <div
                ...
                className="group flex items-center gap-4 border border-border bg-white rounded-xl px-5 py-4 hover:border-primary/40 hover:shadow-sm transition-all cursor-pointer"
              >
